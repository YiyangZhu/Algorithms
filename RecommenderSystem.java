...
public class RecommenderSystem {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println("the normalized predict rate of" + user1 + "of" + item3 + "is" + normalizedPredictRate);
        double predictRate = denormalizPredictRate(user1, normalizedPredictRate);
        //System.out.println("the predict rate of " + user1 + " of " + item3 + " is " + predictRate);
